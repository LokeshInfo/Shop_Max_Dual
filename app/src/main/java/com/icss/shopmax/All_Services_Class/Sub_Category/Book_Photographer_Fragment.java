...
public class Book_Photographer_Fragment extends Fragment
{
    Toolbar toolbar;
    Button book;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_sub_photographer,container,false);
        toolbar = view.findViewById(R.id.phh_toolbar);
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ((MainActivity)getActivity()).onBackPressed();            }        });
        book = view.findViewById(R.id.buttn_bookphh);
